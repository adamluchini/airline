  ...
  public class Flight
  {
    ...
    public override bool Equals (System.Object otherFlight)
    {
      if (otherFlight is Flight)
      {
        ...
        return (flightNameEquality && departureCityEquality && arrivalCityEquality && departureTimeEquality && arrivalTimeEquality && statusEquality);
      }
      else
      {
        return false;
    ...
    public static List<Flight> GetAll()
    {
      ...
      while (rdr.Read())
      {
        ...
        Flight newFlight = new Flight (flightName, departureCity, arrivalCity, departureTime, arrivalTime, status, flightId);
